[![Package on npm](https://img.shields.io/npm/v/@pulsedotso/postgraphile-plugin-fulltext-filter.svg)](https://www.npmjs.com/package/@pulsedotso/postgraphile-plugin-fulltext-filter)
